...
function Wade_vec2()
{
     ...
     * @param {{x: number, y: number}} v1 A 2d vector
     * @param {{x: number, y: number}} v2 Another 2d vector
     * @param {number} [tolerance=0] How different the x and y components can be before the comparison returns false
     * @returns {boolean} Whether v1 and v2 have the same value
     */
    this.equal = function(v1, v2, tolerance)
    {
