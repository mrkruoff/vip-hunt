 ...
 * @returns {Array} A bidimensional array containing all grid elements. The element at column X and row Y can be accessed via returnValue[x][y]. Column and row indices start at 0
 */
...
SceneObject.prototype.serialize = function(stringify, propertiesToExclude, serializeFunctions)
{
    ...
    var exclude = ['autoListen', 'addToSceneParams', 'simulated', 'eventResponse', 'flowChartStatus'];
